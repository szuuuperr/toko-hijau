...
import { Mail, Lock, Eye, EyeOff, User, Phone, Leaf, Loader2 } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block">
            <div className="relative">
              ...
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1633878353628-5fc8b983325c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY28lMjBmcmllbmRseSUyMHByb2R1Y3RzfGVufDF8fHx8MTc2ODExMjkyN3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                alt="Register"
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl">
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex -space-x-2">
                    ...
                    <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-full border-2 border-white"></div>
                    <div className="w-10 h-10 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full border-2 border-white"></div>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-900">5000+ Pengguna</p>
                    <p className="text-xs text-gray-600">Bergabung bulan ini</p>
                  </div>
                </div>
                <p className="text-gray-600">
                  Mulai perjalanan ramah lingkungan Anda bersama kami!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-10">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  Daftar dan mulai berbelanja produk ramah lingkungan
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
